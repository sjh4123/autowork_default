                               ...
                               const UserInterface * const inpVar)
{
    ...
    /*--------------------------------------------------------------------------
     ...
     Generic_3p     tau = tau0*exp(A*f(a,b))
...
void autoWork::makeltfilefrompdb()
{
    ...
    string pdbfolderpath="/Users/SJH/Dropbox/UA_Research/Codes/cppWork/Demo/AA_PIB-Demo/";
    string monoBankpath="/Users/SJH/Dropbox/UA_Research/Codes/cppWork/Demo/AA_PIB-Demo/";
    
    //string pdbfolderpath="/Users/SJH/Dropbox/UA_Research/Codes/cppWork/Demo/AA_OTP-Demo/";
    //string monoBankpath="/Users/SJH/Dropbox/UA_Research/Codes/cppWork/Demo/AA_OTP-Demo/";
    
    string newSpeciesName="Isobutylene_i";//.pdb
    string newltfileID="S001i_T1";//.lt
