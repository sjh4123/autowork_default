                                                ...
                                                vector<vector<double>>& sorted_avg)
{
    ...
    vector<double> sum_columns;//stores values of 2nd to final column of current row
    ...
    if (n_columns>1) //ex. {T,tau,...}
    {
        ...
        do {
            ...
            {
                //if 1st column has the same value, add cumulative column values
                //to current container at current row; count is the number of repeat times
