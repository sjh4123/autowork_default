...
{
    /** NOTE:
     ** This function was intended to be used for create backup of the statistics
     ** folder and screen folder in the analysis.
     ** For test purpose only, this function is temporarily directed to backup
     ** the strings folder in statistics folder. (20170818)
     **/
    ...
    const string usic_d    = sysVar.get_usic();
    const string mkdir=
    //"read -t10 -p \"make new statistics folder? (y/n)\" VAR;"
    //"if [ ${VAR} == y ]; then "
    "   Master="+path_d+";"
    "   usic_dir=${Master}/simulations/"+simType_d+"/"+year_d+"/"+usic_d+";"
    //"   cd ${usic_dir}/analysis;"
