...
namespace autoWork {
    ...
    protected:
        ...
        /* Pure Virtuals */
        virtual double calc_time_given_temp(const alglib::real_1d_array& c,
                                    const double temp,
                                    const std::string& model)=0;
        
        virtual std::vector<double> calc_temp_given_time(const alglib::real_1d_array& c,
                                                 const double time,
                                                 const std::string& model)=0;
        
        virtual void write_tauFitfit_vs_T(std::ofstream& outputFile,
                                          const alglib::real_1d_array& c,
                                          const std::string& model)=0;
        virtual void write_tauFitfit_vs_invT(std::ofstream& outputFile,
                                             const alglib::real_1d_array& c,
                                             const std::string& model)=0;
        ...
        void write_fitModel(std::ofstream& outputFile,
        ...
        void write_errcurve(std::ofstream& outputFile,
                            const std::string& model);
        void write_tauFit_vs_T(std::ofstream& outputFile);
        void write_tauFit_vs_invT(std::ofstream& outputFile);
        void write_badR2(std::ofstream& outputFile,
                         const double r2_threshold);
        void write_insufficientDara(std::ofstream& outputFile,
                                    const int n_fit,
