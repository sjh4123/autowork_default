            ...
            for (int inner=0; inner<n_taueq; ++inner) { //control temperatures
                    ...
                    if (tau_T<fit_tau_threshold) {
                        ...
                        else if (model=="GLM1"||model=="GLM1_hallwolynes")
                        {
                            ...
                            if (GLM1mode=="mode1") {
                                ...
                                xinput=pow(c_model[1],alpha/2)*(pow(u2A/DWF,alpha/2.0)-1.0);
                                yinput=tau_T*log(10)-log(tauA);
                        ...
                        {
                            double shift=c_model[1];
                            double preft=c_model[2];
                ...
                else if (outter==1)
                {
                    ...
                    if (model=="GLM")
                    {
                        ...
                        double tauGLM=calc_time_given_vecinput(c_model,inpVec,model);
                    ...
                    else if(model=="GLM1"||model=="GLM1_hallwolynes")
                    {
                        ...
                        if (GLM1mode=="mode1") {
                            ...
                            lntaurGLM = pow(c_model[1],alpha/2.0)*(pow(u2A/DWF,alpha/2.0)-1.0);
                        } else if (GLM1mode=="mode3") {
                    ...
                    if (model=="GLM1"||model=="univGLM"||model=="GLM1_hallwolynes") {
                        ...
                        write_universal_scaling_dfit(sysVar,models,c_model,c_linear,measured);
                    }
                }
            }
        } writeUniversal << "\n";
                                      ...
                                      const double Temp_d)
{
    ...
    build_penalizedspline_interpolant(stringlen_logtime,1,2,50,rho_Lt);
                                           ...
                                           const int n_sys)
{
    ...
    if (readstringlendata.is_open()) {
        ...
        << "stringlen datafile cannot open.\n";
    }
    try {
        if(stringlen.size()==0) throw 0;
                                            ...
                                            ofstream& writeFile)
{
    ...
    if (GLM1mode=="mode1") {
        ...
        logtaurGLM = pow(c_model[1],alpha/2.0)*(pow(u2A/u2,alpha/2.0)-1.0)*log10(exp(1));
    } else if (GLM1mode=="mode3") {
