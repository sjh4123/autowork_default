...
namespace autoWork
{
    class TheoryTest: public FitData
    {
        ...
        void write_universal_scaling_u2(const StructureClass&,const std::vector<std::string>&,const alglib::real_1d_array&,const alglib::real_1d_array&,const std::vector<std::vector<double>>&,std::ofstream&);
