...
namespace autoWork {
    ...
    private:
        ...
        alglib::real_1d_array c_combined;
        alglib::lsfitreport rep_combined;
        alglib::real_1d_array c_global;
        alglib::lsfitreport rep_global;
        ...
        std::vector<std::vector<double>> dielectric_freq_domains;
        std::vector<std::vector<double>> dielectric_freq_global;
        ...
        void write_master_curve(std::ofstream& outputFile); // old
